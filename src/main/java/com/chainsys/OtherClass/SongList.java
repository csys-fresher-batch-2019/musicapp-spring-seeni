...
public class SongList {
	...
	public String toString() {
		...
		return "SongList [ songName=" + songName + ", musicDirector=" + musicDirector + ", lyricist=" + lyricist
				+ ", singers=" + singers + ", movieName=" + movieName + "]";
	}

	/*
	 * public static boolean spellCheck(String nameCheck) { String str=nameCheck;
	 * char[] ch=str.toCharArray(); String s=""; for (char c : ch) {
	 * if((c==(char)(32))) { s=s+c; } for (int i=65;i<122;i++) {
	 * if(i==91||i==92||1==93||i==94||i==95||i==96) { continue; } else
	 * if(c==(char)(i)) { s=s+c; } } }if(s.equals(str)) { return true; }else {
	 * Logger.error(ErrorConstants.checkInput); return false; } }
