...
INSERT INTO ACCOUNT_INFO(WANTS_TO_PREMIUM,ACCOUNT_NO,DEBIT_CARD,CVV,EXPIRY_MONTH,EXPIRY_YEAR,USER_ID,BALANCE) VALUES('Y',1234567890123456,6078897645231287,432,04,2024,102,500);
INSERT INTO ACCOUNT_INFO(WANTS_TO_PREMIUM,ACCOUNT_NO,DEBIT_CARD,CVV,EXPIRY_MONTH,EXPIRY_YEAR,USER_ID,BALANCE) VALUES('Y',3948123456789019,3214563245625543,342,10,2020,101,300);
INSERT INTO ACCOUNT_INFO(WANTS_TO_PREMIUM,ACCOUNT_NO,DEBIT_CARD,CVV,EXPIRY_MONTH,EXPIRY_YEAR,USER_ID,BALANCE) VALUES('Y',1981234156273890,2366556674556622,567,11,2022,103,400);